import { throttledEffect, destroy } from './signals.mjs'
...
class SimplyBind {
    constructor(options) {
        ...
        if (typeof options.root[Symbol.xRay] !== 'undefined') {
            options.root = options.root[Symbol.xRay]
        }
...
export function transformLiteralByTemplates(context) {
    ...
    if (rendered && rendered?.$bindTemplate != template) {
        if (template) {
